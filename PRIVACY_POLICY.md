...
- Account information (email address, authentication identifiers) via Firebase Authentication.
- Research notes, project records, and other content you or your school create within the platform, stored via Firebase Database and Storage.
- Because this platform has been used in a school context, some content may relate to students. We only collect what's needed for the research/project-database purpose described in the README, and school administrators should ensure use complies with their own student-privacy obligations.
...
We keep data only as long as needed for the purposes above, or as required by our service providers' own retention settings (e.g. Firebase). We take reasonable steps to protect data but, as with any online service, we can't guarantee absolute security.
...
Questions about this policy or your data? Email **robotduck961@gmail.com**.

## A note for schools/guardians

If you are a parent, guardian, or school administrator with questions about student data in this platform, please contact us using the details below.
